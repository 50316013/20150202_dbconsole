...
public class FrameSystemView extends Frame implements ActionListener,WindowListener{
     private Button button1 = new Button("•\Ž¦");
		...
		if(e.getSource()==button1){
			...
			try{
				     ...
				     while(rs.next()){
				    	   ...
				    	   data.addValue(Point,Country,""+Year);
				    	   panel.add(new Label("Year:"+Year+"/Country"+Country+"/Point"+Point));
				           }
		    ...
		    JFreeChart chart = ChartFactory.createLineChart("change of Point",
		                                   "Year",
		                                   "Point",
		                                   data,
